...
const NotMobileDevice = () => {
    return (
        <div style={{ border: '10px solid red', background: 'linear-gradient(to bottom, #000428, #004e92)', width: '100%', height: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
